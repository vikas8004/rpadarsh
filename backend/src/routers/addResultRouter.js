...
import addUnitTestResult from "../controllers/unitTestResult.controller.js"
const addResultRouter = express.Router();

addResultRouter.route("/result/addresult/add-all-result").post(addAllResult);
addResultRouter.route("/result/addresult/add-unit-test-result").post(addUnitTestResult);
